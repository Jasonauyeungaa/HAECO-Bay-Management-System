            ...
            if (aircraft) {
                html += `
                    <div class="aircraft-info mt-2">
                        ...
                        <div class="property"><strong>Arrival:</strong> ${new Date(aircraft.arrivalTime).toLocaleString()}</div>
                        <div class="property"><strong>Departure:</strong> ${new Date(aircraft.departureTime).toLocaleString()}</div>
