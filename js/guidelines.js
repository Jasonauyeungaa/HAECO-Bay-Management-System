...
class GuidelinesManager {
    ...
    loadGuidelines() {
        return {
            bayAssignment: {
                ...
                <h4>MTE Logic:</h4>
                <ul>
                    <li>Only 2 MTE units available system-wide</li>
                    <li>A,B,J can activate MTE for urgent maintenance (becomes In Bay)</li>
                    <li>MTE automatically activates for urgent maintenance aircraft</li>
                    <li>Regular maintenance uses standard In Bays</li>
                </ul>
                <h4>Assignment Priority:</h4>
                <ol>
                    <li>Urgent aircraft → Paint/In bays or MTE activation</li>
                    <li>High priority → Available In/Paint bays</li>
                    <li>Normal/Low → Outside bays or remaining capacity</li>
                </ol>
                `
            },
            operations: {
                ...
                <ul>
                    ...
                    <li>Check MTE availability for urgent maintenance</li>
            ...
            troubleshooting: {
                ...
                <ul>
                    ...
                    <li><strong>MTE Not Available:</strong> Check if 2 units already in use</li>
    ...
    showGuidelines() {
        const modal = this.createModal('HAECO V6 Guidelines', `
